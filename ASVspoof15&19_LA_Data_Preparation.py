...
if __name__ == '__main__':
    ...
    root_path = "D:/DATASET TACOTRON2/Atsisiuti konvertuoti/"
    train_data_path     = root_path + 'train/'
    train_protocol_path = root_path + 'train1.txt'
    dev_data_path = root_path + 'dev/'
    dev_protocol_path = root_path + 'dev1.txt'
    eval_data_path     = root_path + 'eval/'
    eval_protocol_path = root_path + 'eval1.txt'
    
    # directory info of ASVspoof2019 dataset
##    root_path = 'F:/ASVspoof2019/LA/'
##    root_path = 'D:/end-to-end-synthetic-speech-detection-main/LA/LA/'
##    
...
##
##
####    C:\Users\emili\Downloads\end-to-end-synthetic-speech-detection-main\LA\LA\ASVspoof2019_LA_cm_protocols
##    
##
...
##   train_data_path     = root_path + 'wav_train/'
##    dev_data_path       = root_path + 'wav_dev/'
##    eval_data_path      = root_path + 'wav_eval/'
